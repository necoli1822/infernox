...
use easel::exponential::esl_exp_surv;
use easel::gumbel::esl_gumbel_invsurv;
...
pub fn f3_filter_sequence(
    ...
    // C 2552-2620: Filter 1 (SSV longtarget) + p7_pli_ExtendAndMergeWindows +
    // split any window > 2*cmW. All of this is inside f1_msv_windows().
    let wins = f1_msv_windows(mf, chunk_dsq, win_len, f1, cmw);
    let nwin = wins.len();
    ...
    for (i, w) in wins.iter().enumerate() {
        ...
        // C 2752-2762: Filter 3, local Forward.
        ...
        let fwdsc = forward_filter_score(ff, &sub, wlen);
        ...
        // C 2765-2766: n_past_fwd++; survAA[p7_SURV_F3][i]=TRUE.

        // C 2772-2784: Filter 3b, Forward composition bias (have_filtersc path).
        ...
        // C 2785-2787: n_past_fwdbias++; nsurv_fwd++; survAA[p7_SURV_F3b][i]=TRUE.
        surv_f3b[i] = true;
    }
